...
var segmentAnalytics = require('./send-analytics');
...
function MigrationStream() {
  ...
  migrationStream._transform = function(tile, enc, callback) {
    ...
    var segmentData = {'event':'Upload Tile Version', 'anonymousId':uniqid}
    ...
    if (v2 === true) {
      ...
      if(sentToSegment==false){
        segmentData['tile_version'] = 'V1';
        segmentAnalytics.sendAnalytics(segmentData, function(err, result){
